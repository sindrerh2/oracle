package no.nav.oracle.repository;

import no.nav.oracle.OracleApp;
import no.nav.oracle.config.Constants;
import no.nav.oracle.config.audit.AuditEventConverter;
import no.nav.oracle.domain.PersistentAuditEvent;
...
import static no.nav.oracle.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
