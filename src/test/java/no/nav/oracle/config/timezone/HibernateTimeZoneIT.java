package no.nav.oracle.config.timezone;

import no.nav.oracle.OracleApp;
import no.nav.oracle.repository.timezone.DateTimeWrapper;
import no.nav.oracle.repository.timezone.DateTimeWrapperRepository;
