package no.nav.oracle.web.rest;

import no.nav.oracle.OracleApp;
import no.nav.oracle.config.Constants;
import no.nav.oracle.domain.Authority;
import no.nav.oracle.domain.PersistentToken;
import no.nav.oracle.domain.User;
import no.nav.oracle.repository.AuthorityRepository;
import no.nav.oracle.repository.PersistentTokenRepository;
import no.nav.oracle.repository.UserRepository;
import no.nav.oracle.security.AuthoritiesConstants;
import no.nav.oracle.service.MailService;
import no.nav.oracle.service.UserService;
import no.nav.oracle.service.dto.PasswordChangeDTO;
import no.nav.oracle.service.dto.UserDTO;
import no.nav.oracle.web.rest.errors.ExceptionTranslator;
import no.nav.oracle.web.rest.vm.KeyAndPasswordVM;
import no.nav.oracle.web.rest.vm.ManagedUserVM;
